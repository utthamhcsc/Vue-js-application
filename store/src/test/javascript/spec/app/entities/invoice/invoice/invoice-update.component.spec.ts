...
import InvoiceUpdateComponent from '@/entities/invoice/invoice/invoice-update.vue';
import InvoiceClass from '@/entities/invoice/invoice/invoice-update.component';
