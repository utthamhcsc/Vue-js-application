...
export default class CustomerComponentsPage extends AlertPage {
...
export class CustomerDeleteDialog {
  ...
  title: ElementFinder = element(by.id('storeApp.customer.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-customer'));
}
