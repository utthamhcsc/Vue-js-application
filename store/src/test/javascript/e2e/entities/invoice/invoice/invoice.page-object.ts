...
export default class InvoiceComponentsPage extends AlertPage {
...
export class InvoiceDeleteDialog {
  ...
  title: ElementFinder = element(by.id('storeApp.invoiceInvoice.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-invoice'));
}
