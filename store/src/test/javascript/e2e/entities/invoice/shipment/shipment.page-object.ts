...
export default class ShipmentComponentsPage extends AlertPage {
...
export class ShipmentDeleteDialog {
  ...
  title: ElementFinder = element(by.id('storeApp.invoiceShipment.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-shipment'));
}
