...
export default class OrderItemComponentsPage extends AlertPage {
...
export class OrderItemDeleteDialog {
  ...
  title: ElementFinder = element(by.id('storeApp.orderItem.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-orderItem'));
}
