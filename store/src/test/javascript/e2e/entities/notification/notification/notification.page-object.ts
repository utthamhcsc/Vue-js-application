...
export default class NotificationComponentsPage extends AlertPage {
...
export class NotificationDeleteDialog {
  ...
  title: ElementFinder = element(by.id('storeApp.notificationNotification.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-notification'));
}
