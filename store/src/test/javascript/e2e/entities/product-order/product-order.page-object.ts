...
export default class ProductOrderComponentsPage extends AlertPage {
...
export class ProductOrderDeleteDialog {
  ...
  title: ElementFinder = element(by.id('storeApp.productOrder.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-productOrder'));
}
