  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="storeApp.notificationNotification.home.createOrEditLabel"
          data-cy="NotificationCreateUpdateHeading"
          v-text="$t('storeApp.notificationNotification.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            ...
            <div v-if="$v.notification.date.$anyDirty && $v.notification.date.$invalid">
              ...
              <small
                ...
                v-if="!$v.notification.date.ZonedDateTimelocal"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('storeApp.notificationNotification.details')" for="notification-details"
              >Details</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('storeApp.notificationNotification.sentDate')" for="notification-sentDate"
              >Sent Date</label
            >
            <div class="d-flex">
              <input
            ...
            <div v-if="$v.notification.sentDate.$anyDirty && $v.notification.sentDate.$invalid">
              ...
              <small
                class="form-text text-danger"
                v-if="!$v.notification.sentDate.ZonedDateTimelocal"
                v-text="$t('entity.validation.ZonedDateTimelocal')"
              >
                This field should be a date and time.
              </small>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('storeApp.notificationNotification.format')" for="notification-format"
              >Format</label
            >
            <select
              class="form-control"
            ...
            >
              <option
                ...
                v-bind:label="$t('storeApp.NotificationType.' + notificationType)"
              >
                {{ notificationType }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('storeApp.notificationNotification.userId')" for="notification-userId"
              >User Id</label
            >
            <input
              type="number"
              ...
              data-cy="userId"
              :class="{ valid: !$v.notification.userId.$invalid, invalid: $v.notification.userId.$invalid }"
              v-model.number="$v.notification.userId.$model"
              required
            />
            <div v-if="$v.notification.userId.$anyDirty && $v.notification.userId.$invalid">
              ...
              <small class="form-text text-danger" v-if="!$v.notification.userId.numeric" v-text="$t('entity.validation.number')">
                This field should be a number.
              </small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('storeApp.notificationNotification.productId')" for="notification-productId"
              >Product Id</label
            >
            <input
              type="number"
            ...
            <div v-if="$v.notification.productId.$anyDirty && $v.notification.productId.$invalid">
              ...
              <small class="form-text text-danger" v-if="!$v.notification.productId.numeric" v-text="$t('entity.validation.number')">
                This field should be a number.
              </small>
            </div>
          </div>
