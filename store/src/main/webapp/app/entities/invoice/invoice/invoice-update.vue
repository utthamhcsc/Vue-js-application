  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="storeApp.invoiceInvoice.home.createOrEditLabel"
          data-cy="InvoiceCreateUpdateHeading"
          v-text="$t('storeApp.invoiceInvoice.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('storeApp.invoiceInvoice.paymentMethod')" for="invoice-paymentMethod"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('storeApp.invoiceInvoice.paymentDate')" for="invoice-paymentDate"
              >Payment Date</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('storeApp.invoiceInvoice.paymentAmount')" for="invoice-paymentAmount"
