...
class VuejsApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        VuejsApplicationKafkaResource kafkaResource = new VuejsApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/vuejs-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/vuejs-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
