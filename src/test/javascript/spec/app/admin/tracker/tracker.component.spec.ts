...
describe('JhiTracker', () => {
  ...
  let jhiTrackerView: JhiTrackerComponent;
  ...
  it('should add new activity', () => {
    ...
    jhiTrackerView.activities = [activity1];
    ...
    // THEN
    expect(jhiTrackerView.activities).toEqual([activity1, activity2]);
  });
  ...
  it('should not add logout activity', () => {
    ...
    // THEN
    expect(jhiTrackerView.activities).toEqual([]);
  });

  it('should update user activity', () => {
    // GIVEN
    jhiTrackerView.activities = [{ page: 'login', sessionId: '123' }];
    ...
    // THEN
    expect(jhiTrackerView.activities).toEqual([activity]);
  });
