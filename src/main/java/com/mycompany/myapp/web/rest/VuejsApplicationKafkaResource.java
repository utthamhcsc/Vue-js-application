...
@RestController
@RequestMapping("/api/vuejs-application-kafka")
public class VuejsApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(VuejsApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public VuejsApplicationKafkaResource(KafkaProperties kafkaProperties) {
